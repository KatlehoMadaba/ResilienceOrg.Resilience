...
namespace ResilienceOrg.Resilience.Common.Authorization
{
    /// <summary>
    /// Resilience Permission checker
    /// </summary>
    public class ResiliencePermissionChecker : ICustomPermissionChecker, IResiliencePermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public ResiliencePermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
