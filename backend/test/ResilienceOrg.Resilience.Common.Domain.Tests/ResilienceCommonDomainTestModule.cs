...
using ResilienceOrg.Resilience.Tests.DependencyInjection;
using Shesha;
...
namespace ResilienceOrg.Resilience.Common.Tests
{
    [DependsOn(
    ...
    public class ResilienceCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public ResilienceCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
